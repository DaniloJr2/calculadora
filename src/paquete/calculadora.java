...
public class calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        casilla.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 102)));
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        switch(this.operador){
            ...
            case "-":this.casilla.setText(sincero(this.primernumero-this.segundonumero));break;
            case "*":this.casilla.setText(sincero(this.primernumero*this.segundonumero));break;
            case "/": if(this.segundonumero==0){ this.casilla.setText("NoSeDiivideEntreCero");}  
            else
